...
function load() {
    ...
    function run(gl) {
        ...
        var linePrimitiveVerticies = new Float32Array([-1, -1,      -1, 0.6,
                                                        -1, 0.6,    1, 0.6,
                                                        1, 0.6,     1, -1,
                                                        1, -1,      -1, 0.6,
                                                        -1, 0.6,    0, 1,
        ...
        gl.bufferData(gl.ARRAY_BUFFER, linePrimitiveVerticies, gl.STATIC_DRAW);
        ...
        gl.drawArrays(gl.LINES, 0, (linePrimitiveVerticies.length / 2));
    }
//});